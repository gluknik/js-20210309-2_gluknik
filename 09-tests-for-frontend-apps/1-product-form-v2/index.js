...
export default class ProductForm {
  ...
  createImagesList () {
    ...
    const items = this.formData.images.map(item => {
      ...
      listElement.innerHTML = this.getImageItem(item.url, item.source).outerHTML;
      return listElement.firstElementChild;
    });
    this.imagesList = new SortableList({items});
    imageListContainer.append(this.imagesList.element);
  }
